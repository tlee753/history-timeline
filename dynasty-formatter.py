...
colors = ["coral", "darkturquoise", "dodgerblue", "floralwhite", "plum", "chocolate", "lavender", "lightslategray", "honeydew", "lightsteelblue", "springgreen", "wheat", "slateblue", "orchid", "darkorange", "lightsteelblue", "mediumaquamarine"]
...
<body>
    ...
    for region in history:
        ...
        for dynasty in history[region]:
            ...
            outFile.write(
"""
    <div class="dynasty" style="top: {0}px; height: {1}px; {2}background: {3};">
